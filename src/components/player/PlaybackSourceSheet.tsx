      ...
      <View style={styles.backdrop}>
        <BlurView intensity={40} tint="dark" style={styles.sheet}>
          <View style={styles.header}>
            <Text style={styles.title}>Playback sources</Text>
          ...
          <Text style={styles.explainer}>
            Add an Invidious, Piped, or custom stream endpoint so tracks can play.
          </Text>
          ...
          <ScrollView style={{ maxHeight: 220, marginTop: SIZES.md }}>
            {endpoints.length === 0 ? (
              <Text style={styles.status}>No sources yet.</Text>
            ) : (
              endpoints.map((e) => (
